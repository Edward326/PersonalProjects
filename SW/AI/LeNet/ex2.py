...
batch_size, lrate, num_epochs = 256, 0.5, 10
network_typeName="LeNet"
...
def train(net, train_iter, val_iter, test_iter, num_epochs, lr, device,device2,alreadyParameters):
    ...
    if(alreadyParameters=='already_learned'):
        net.load_state_dict(torch.load('ex2__LeNet_parameters.pth'))
        net.eval()
    ...
    torch.save(net.state_dict(), 'ex2__LeNet_parameters.pth')#save the parameters
